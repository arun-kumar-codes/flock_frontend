...
export default function DashboardBlogDetailPage({
  ...
  type BlogComment = Blog["blog"]["comments"][number];
    ...
    {formatDate(blog.blog?.created_at || "")}
              ...
              {blog.blog?.keywords && blog.blog.keywords.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {blog.blog?.keywords.map((keyword:string, index:number) => (
                      <span
                        key={index}
              ...
              {blog.blog?.locations && blog.blog.locations.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {blog.blog?.locations.map((location:string, index:number) => (
                      <span
                        key={index}
              ...
              {blog.blog?.brand_tags && blog.blog.brand_tags.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {blog.blog?.brand_tags.map((tag:string, index:number) => (
                      <span
                        key={index}
              ...
              <div className="max-h-96 overflow-y-auto">
                {blog.blog?.comments && blog.blog.comments.length > 0 ? (
                  <div className="p-4 space-y-4">
                    {blog.blog?.comments
                      .sort((a: BlogComment, b: BlogComment) => {
