...
<div className="relative inline-block ">
  ...
  <select
    ...
    className="pl-10 pr-8 py-2 md:py-3 theme-input rounded-xl theme-text-primary min-w-[180px] 
               appearance-none focus:ring-2 focus:ring-purple-500 focus:border-transparent 
