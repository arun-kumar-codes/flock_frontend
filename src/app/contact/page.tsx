    ...
    const checkAuth = async () => {
      ...
      try {
        ...
        if (res?.status === 200) {
          ...
          // backend usually returns in res.data.user.role; keep both to be safe
          const rawRole =
            res?.data?.user?.role ??
            res?.data?.role ??
            null;
      ...
      <header className="relative z-30 w-full px-4 md:px-6 lg:px-10 py-3 md:py-4">
        <div className="w-full flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            {/* While checking auth: show nothing (or you can show a skeleton) */}
            {!authChecked ? null : !isLoggedIn ? (
              ...
              // Logged in but role not known yet (or unexpected role) → disable to prevent wrong navigation
              <button
                disabled
        ...
        <div className="bg-white/95 rounded-3xl shadow-xl px-6 py-8 md:px-10 md:py-12 theme-text-primary">
          ...
          <header className="text-center mb-10">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              We're here to support your journey as a creator or viewer on the FLOCK platform.
              If you have questions, feedback, or need assistance, please use the information below
              to reach out to the appropriate team.
            </p>
          </header>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-6 md:p-8 border border-red-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-4">
                If you believe a user, content, or interaction violates our guidelines or presents a
                safety concern, please report it using platform tools whenever possible.
              </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-200 shadow-sm">
              ...
              <p className="text-base md:text-lg text-gray-700">
                We aim to respond within 2–4 business days, depending on the nature and volume of
                requests.
              </p>
            </div>
